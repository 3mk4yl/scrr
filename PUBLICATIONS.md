...
* `[2]` [Data Poisoning and LLM Manipulation](./dossiers/2026/1_adversarial_machine/2_data_poisoning.md)
* `[3]` [The Evolution of Agentic Ransomware](./dossiers/2026/1_adversarial_machine/3_agentic_ransomware.md)
* `[4]` [Automated Command & Control Infrastructure](./dossiers/2026/1_adversarial_machine/4_automated_c2.md)
